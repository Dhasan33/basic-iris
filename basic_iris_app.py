...
sep_len = st.slider('Sepal Length',0.0,10.0)
sep_wid =  st.slider('Sepal Width',0.0,10.0)
pet_len = st.slider('Petal Length',0.0,10.0)
pet_wid = st.slider('Petal Width',0.0,10.0)
if st.button('Predict'):
	pre = prediction(sep_len,sep_wid,pet_len,pet_wid)
	st.write('Species Predict:',pre)
